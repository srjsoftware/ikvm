...
public class UnixPollArrayWrapper extends AbstractPollArrayWrapper {

    // File descriptor to write for interrupt
    int interruptFD;

    UnixPollArrayWrapper(int newSize) {
     ...
     * the same array.
     */
    static void replaceEntry(UnixPollArrayWrapper source, int sindex,
                      UnixPollArrayWrapper target, int tindex) {
    ...
    void grow(int newSize) {
        // create new array
        UnixPollArrayWrapper temp = new UnixPollArrayWrapper(newSize);
