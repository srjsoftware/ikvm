...
class WindowsPollArrayWrapper {
    ...
    WindowsPollArrayWrapper(int newSize) {
    ...
    void replaceEntry(WindowsPollArrayWrapper source, int sindex,
                                     WindowsPollArrayWrapper target, int tindex) {
    ...
    void grow(int newSize) {
        WindowsPollArrayWrapper temp = new WindowsPollArrayWrapper(newSize);
