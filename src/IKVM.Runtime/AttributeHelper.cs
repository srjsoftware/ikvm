...
namespace IKVM.Internal
{
    ...
    static class AttributeHelper
    {
        ...
        /// <summary>
        /// Parses the string value into the type indiciated by the <see cref="TypeWrapper"/>.
        /// </summary>
        ...
        static object ParseValue(ClassLoaderWrapper loader, TypeWrapper tw, string val)
        {
        ...
        {
            var cab = CreateCustomAttribute(loader, attr, out var declarativeSecurity);
        ...
        static void GetAttributeArgsAndTypes(ClassLoaderWrapper loader, IKVM.Tools.Importer.MapXml.Attribute attr, out Type[] argTypes, out object[] args)
        {
        ...
        {
            return CreateCustomAttribute(loader, attr, out _);
        }

        static CustomAttributeBuilder CreateCustomAttribute(ClassLoaderWrapper loader, IKVM.Tools.Importer.MapXml.Attribute attr, out bool isDeclarativeSecurity)
        {
            // TODO add error handling
            Type[] argTypes;
            object[] args;
        ...
        private static CustomAttributeBuilder GetEditorBrowsableNever()
        {
            if (editorBrowsableNever == null)
            {
                ...
                ConstructorInfo ctor = (ConstructorInfo)typeofEditorBrowsableAttribute.__CreateMissingMethod(ConstructorInfo.ConstructorName, CallingConventions.Standard | CallingConventions.HasThis, null, default(CustomModifiers), new Type[] { typeofEditorBrowsableState }, null);
