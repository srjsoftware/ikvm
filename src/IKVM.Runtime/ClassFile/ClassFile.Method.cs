...
namespace IKVM.Internal
{
    ...
    sealed partial class ClassFile
    {
        ...
        internal sealed partial class Method : FieldOrMethod
        {
            ...
            internal Method(ClassFile classFile, string[] utf8_cp, ClassFileParseOptions options, BigEndianBinaryReader br) :
                base(classFile, utf8_cp, br)
            {
                ...
                var attributes_count = br.ReadUInt16();
