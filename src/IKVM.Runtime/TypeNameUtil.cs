...
namespace IKVM.Internal
{
    ...
    static class TypeNameUtil
    {
        ...
        const string specialCharactersString = "\\+,[]*&\u0000";

        internal const string ProxiesContainer = "__<Proxies>";

        /// <summary>
        /// Replaces characters that are not compatible with CLR type names.
        /// </summary>
        ...
        /// <summary>
        /// Generates the name of a proxy that implements the specified interfaces.
        /// </summary>
